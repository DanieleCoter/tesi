...
public class Doctor2Activity extends Activity {
    ...
    private void launchRingDialog() {
        final ProgressDialog ringProgressDialog = ProgressDialog.show(Doctor2Activity.this, "Please wait ...", "contacting server ...", true);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    Thread.sleep(2000);
                    Intent i = new Intent(Doctor2Activity.this, Splash2Activity.class);
