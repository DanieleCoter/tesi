...
public class LogIn2Activity extends Activity {
    ...
    private Activity logIn2Activity;//this activity
        ...
        logIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.getText().toString().isEmpty() || password.getText().toString().isEmpty()) {
                    final AlertDialog.Builder alert = new AlertDialog.Builder(logIn2Activity);
                    ...
                    post.myPostCall(TypeCall.LOG_IN, logIn2Activity);
                    launchRingDialog();
                ...
                if (firstName.getText().toString().isEmpty() || lastName.getText().toString().isEmpty() || eMail.getText().toString().isEmpty() || myColor.getText().toString().isEmpty() || formDate.getText().toString().isEmpty()) {
                    ...
                    if (!password.getText().toString().equals(confirmPassword.getText().toString())) {
                        ...
                        if (!password.getText().toString().isEmpty()) {
                            ...
                            post.myPostCall(TypeCall.SIGN_UP, logIn2Activity);
                            launchRingDialog();
                        } else {
    ...
    private void forgotPasswordAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                post.myPostCall(TypeCall.RESET, logIn2Activity);
                launchRingDialog();
            }
        });
        alert.setNegativeButton("Cancel",
    ...
    private void updateInfoAlert() {
        ...
        alert = new AlertDialog.Builder(LogIn2Activity.this);
    ...
    private void updateEmailAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                post.myPostCall(TypeCall.UPDATE_MAIL, logIn2Activity);
            }
        });
        alert.setNegativeButton("Cancel",
                new DialogInterface.OnClickListener() {
    ...
    private void updateFirstnameAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                postUpdate.myPostCall(TypeCall.UPDATE_FIRSTNAME, logIn2Activity);
            }
        });
        alert.setNegativeButton("Cancel",
                new DialogInterface.OnClickListener() {
    ...
    private void updateLastnameAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                post = new PostCall(id_user, newValue.getText().toString(), statusUpdate, true);
                post.myPostCall(TypeCall.UPDATE_LASTNAME, logIn2Activity);
            }
        });
        alert.setNegativeButton("Cancel",
                new DialogInterface.OnClickListener() {
    ...
    private void updateBirthdayAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                post.myPostCall(TypeCall.UPDATE_BIRTHDAY, logIn2Activity);
            }
        });
        alert.show();
    ...
    private void updatePasswordAlert() {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                post.myPostCall(TypeCall.UPDATE_PASSWORD, logIn2Activity);
    ...
    private void launchRingDialogUpdate() {
        final ProgressDialog ringProgressDialog = ProgressDialog.show(LogIn2Activity.this, "Please wait ...", "contacting server ...", true);
            ...
            public void run() {
                try {
                    ...
                    if (statusUpdate.getText().toString().equals("0")) {
                        logIn2Activity.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                updateEmailAlert();
                            }
            ...
            public void run() {
                try {
                    ...
                    if (doctor.contains("1")) {
                        Intent i = new Intent(LogIn2Activity.this, Doctor2Activity.class);
                        ...
                        if (settings2.getBoolean("isCheck", false)) {
                            Intent i = new Intent(LogIn2Activity.this, Splash2Activity.class);
                            i.putExtra("id_user", id_user);
                            startActivity(i);
                        }
                        else {

                            Intent i = new Intent(LogIn2Activity.this, TutorialActivity.class);
                            i.putExtra("id_user", id_user);
                            startActivity(i);
                        }
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    Toast.makeText(LogIn2Activity.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                }
